...
export class nfpm__positionsResult {
  value0: BigInt;
  value1: Address;
  value2: Address;
  value3: Address;
...
export class nfpm extends ethereum.SmartContract {
  static bind(address: Address): nfpm {
    return new nfpm("nfpm", address);
  }
  ...
  positions(tokenId: BigInt): nfpm__positionsResult {
    let result = super.call(
      "positions",
    ...
    return new nfpm__positionsResult(
      result[0].toBigInt(),
      result[1].toAddress(),
      result[2].toAddress(),
      result[3].toAddress(),
  ...
  try_positions(tokenId: BigInt): ethereum.CallResult<nfpm__positionsResult> {
    let result = super.tryCall(
      "positions",
      "positions(uint256):(uint96,address,address,address,uint24,int24,int24,uint128,uint256,uint256,uint128,uint128)",
      [ethereum.Value.fromUnsignedBigInt(tokenId)]
